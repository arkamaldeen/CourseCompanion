 ...
 * Header for profile view with Profile text and icon on left, Course Companion on right
 */
export const ProfileHeader = () => {
  ...
  return (
    <div className="cc-chat-header">
      {/* LEFT SIDE - Profile Title + Icon */}
      <div className="cc-chat-header-left">
        <span className="cc-chat-title">Profile</span>
        <svg
      ...
      {/* RIGHT SIDE - Course Companion Label */}
